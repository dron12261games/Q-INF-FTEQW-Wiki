...
- **`tcMod ...`** / **`tcGen ...`** (он же [`texgen`](../40-shader-directives-reference/02-shader-stage-directives.md#texgen)) — анимация и генерация текстурных координат слоя (скролл, вращение, волны, эффект окружения) — полностью описаны на странице [«Анимация текстурных координат»](./texcoord-animation.md).
